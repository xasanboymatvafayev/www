...
export const translations = {
  uz: {
    ...
    rateLimited: "Bloklangan",
    quotaNotice: "Server limiti to'ldi. Hozir yangi kanal oching yoki ma'lumotni eksport qiling.",
  ...
  en: {
    ...
    syncing: "Syncing...",
    rateLimited: "Blocked",
    quotaNotice: "Server limit reached. Create new channel or export data now.",
  ...
  ru: {
    ...
    rateLimited: "Заблокирован",
    quotaNotice: "Лимит сервера исчерпан. Создайте новый канал или экспортируйте данные сейчас.",
    ...
    student: "Студент",
    score: "Балл",
    accountSettings: "Настройки аккаунта и синхронизации.",
    cloudSync: "Облачная синхронизация",
    syncStatus: "Статус",
    online: "Онлайн",
    offline: "Оффлайн",
    lastSync: "Последняя активность",
    cloudDesc: "Ваши данные автоматически синхронизируются между устройствами.",
    ...
    exportData: "Экспорт",
    importData: "Импорт",
    importWarning: "Это перезапишет локальные данные. Продолжить?",
    login: "Вход",
    register: "Регистрация",
    createAccount: "Создать аккаунт",
    username: "Имя пользователя",
    password: "Пароль",
    adminSecret: "Секрет админа",
    loginTaken: "Имя пользователя занято!",
    incorrectSecret: "Неверный секрет!",
    resetSystem: "Сброс",
    mentorGreeting: "Привет! Я ваш AI-наставник. Чем я могу вам помочь сегодня?",
    mentorTitle: "AI Наставник",
