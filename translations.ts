...
export const translations = {
  uz: {
    ...
    rateLimited: "Limit to'lgan",
    quotaNotice: "Kunlik limit tugadi. Ma'lumotlar faqat qurilmangizda saqlanmoqda.",
  ...
  en: {
    ...
    syncing: "Syncing...",
    rateLimited: "Quota Full",
    quotaNotice: "Daily API limit reached. App is running in Local Mode.",
  ...
  ru: {
    ...
    quotaNotice: "Лимит API на сегодня исчерпан. Работа в локальном режиме.",
